...
$tahun=date('Y');
$sql="select pembayaran,id_kegiatan,sum(jumlah) as jumlah ,sum(pajak) as pajak,sum(jumlah_bersih) as bersih from kwitansi_dinas.kwitansiview where concat(date_part('month',tanggal),date_part('year',tanggal))='".$bulan.$tahun."' group by pembayaran,id_kegiatan order by id_kegiatan";
...
<h3 align="center">Data Pajak Per Belanja</h3>
<hr>
