        ...
        $anggaran=0;
            ...
            ?>
                ...
                <tr>
                    ...
                    <br>                    </td>
                    <td colspan="2" valign="top">: <?php echo $namabulan[$rincianobjek['bulan']-1];?></td>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                ...
                <tr class="left right">
                    ...
                    <td align="center" valign="top" class="border"><?php 
                    if($ro['uraian_keluar']==""){
                        $nokel="";
                    }
                    echo $nokel; ?></td>
                    <td align="center" valign="top" class="border"><?php 
                    if($ro['tanggal_keluar']==""){
                        $tglkeluar="";
                    }else{
                        $tglkeluar=date_format(date_create($ro['tanggal_keluar']), 'd-m-Y');
                    }
                    
                    echo ($tglkeluar=="")? "": $tglkeluar ;?></td>
...
<!--					todo: where bulan ini-->
                ...
                <tr>
                    ...
                    <td valign="top">&nbsp;</td>
                    <td valign="top">&nbsp;</td>
                    <td align="right" valign="top">Dempel, 30 <?php echo ucfirst(strtolower($namabulan[$rincianobjek['bulan']-1]))." ".date('Y'); ?></td>
                    <td valign="top">&nbsp;</td>
                </tr>
                <tr>
