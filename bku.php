...
<div class="btn-toolbar" role="toolbar">
  ...
  <div class="printarealand">
    <div class="printcontent">
      <p align="center">BUKU KAS UMUM<br>
      ...
      <table width="100%" class="table-hover">
        ...
        <tbody>
          ...
          // echo $penerimaanlalu."<br/>";
          $pengeluaranlalu = ExecuteScalar($conn, "select sum(jumlah) from kwitansi_dinas.bku where date_part('month',tanggal)<'" . $bulan . "' and (isdebet='t' and date_part('year',tanggal)='".$tahun."')", 0);
          $saldolalu = $penerimaanlalu - $pengeluaranlalu;
          // echo $saldolalu . " = ". $penerimaanlalu . " - ". $penerimaanlalu;
          ?>
          <tr class="border">
            <td></td>
            <td></td>
          ...
          $kumulatifterima = $kumulatifterima + $penerimaan;
          $kumulatif = $kumulatif + $pengeluaran;
          ...
          <tr class="border">
            ...
            <td align="center"><?php if ($row['isdebet'] == 't' && $row['ispajak'] == 'f') {
              echo $no_bukti;
              }
              else {
              echo "";
          ...
          <tr class="border" style="<?php if ($pph42 == 0 || $pph42 = '') {
            ...
            <td><?php echo date_format($tanggal, 'd/m/Y'); ?></td>
            <td><?php echo $row['kode_rekening']; ?></td>
            <td><?php echo "Terima PPh 4 ayat 2"; ?></td>
            <td align="center"><?php echo $no_bukti; ?></td>
          ...
          <tr class="border" style="<?php if ($resto == 0 || $resto = '') {
            ...
            <td><?php echo date_format($tanggal, 'd/m/Y'); ?></td>
            <td><?php echo $row['kode_rekening']; ?></td>
            <td><?php echo "Terima Pajak Restoran"; ?></td>
            <td align="center"><?php echo $no_bukti; ?></td>
